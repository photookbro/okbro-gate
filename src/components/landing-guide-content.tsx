export function LandingGuideContent() {
  return (
    <article className="landing-guide-article">
      ...
      <div className="landing-guide-lede">
        ...
        <p>
          새롭게 도입되는 <span className="landing-guide-brand-gate">OKbro Gate</span>와 함께라면
          가능합니다.
        </p>
      </div>

      <ol className="landing-guide-features">
        <li className="landing-guide-feature">
          <strong className="landing-guide-feature-title">간편한 참여 방식</strong>
          <p className="landing-guide-feature-body">
            <span className="landing-guide-brand-okyeong">오켱</span>의 출사가 예정된 대회에서, 경기 시작
            전 &apos;스위치 ON&apos;, 경기 종료 후 &apos;스위치 OFF&apos;만 설정해 주세요.
          </p>
        </li>
        <li className="landing-guide-feature">
          <strong className="landing-guide-feature-title">스마트한 시간 알림</strong>
          <p className="landing-guide-feature-body">
            당신이 <span className="landing-guide-brand-okyeong">오켱</span> 작가의 카메라 렌즈 앞(근처)을
            통과한 정확한 찰나의 시각을 알림으로 신속하게 전해드립니다.
          </p>
        </li>
        <li className="landing-guide-feature">
          ...
          <p className="landing-guide-feature-body">
            전달받은 가이드 시각을 기반으로{' '}
            <span className="landing-guide-brand-okyeong">오켱</span> 앨범에서 즉시 검색해 보세요. 무한
            스크롤의 피로감 없이, 오직 당신만을 위한 최고의 컷을 곧바로 마주할 수 있습니다. 우측하단에
            시각 표시!
          </p>
        </li>
        <li className="landing-guide-feature">
          ...
          <p className="landing-guide-feature-body">
            기존의 구글앨범의 배번호 인식 시스템에{' '}
            <span className="landing-guide-brand-gate">OKbro Gate</span>를 함께 활용하신다면, 당신의 위대한
