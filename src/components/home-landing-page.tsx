      ...
      <main className="hl-wrap">
        <section>
          ...
          <div className="hl-extra-grid">
            ...
            <div className="hl-extra-card">
              <div className="hl-extra-tag hl-label">SHOP</div>
              <h3>대회 준비, 가성비로</h3>
              <p>러닝벨트, 방수팩, 헤어밴드까지 — 종목별로 큐레이션한 장비를 바로 둘러보세요.</p>
              <Link href="/shop" className="hl-extra-link" data-guest-allowed>
                SHOP 둘러보기 →
              </Link>
            </div>
            <div className="hl-extra-card">
              <div className="hl-extra-tag hl-label">진단</div>
              <h3>내 몸 상태, 50문항으로</h3>
              <p>간단한 자가진단으로 영역별 컨디션을 확인하고 맞춤 케어 방향을 받아보세요.</p>
              <Link href="/diagnosis" className="hl-extra-link" data-guest-allowed>
                진단 시작하기 →
              </Link>
            </div>
          </div>
        ...
        <div className="hl-wrap">
          <div className="hl-foot-grid">
            ...
            <div className="hl-foot-links">
              ...
              <div className="hl-foot-col">
                <h4 className="hl-label">POLICY</h4>
                <span>개인정보처리방침</span>
                <span>이용약관</span>
              </div>
            </div>
