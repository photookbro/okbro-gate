...
const sample = `상품명,쇼핑몰,이미지URL,정가,할인가,제휴링크,카테고리,순서
러닝화 A,쿠팡,https://img.example/a.jpg,"129,000","89,000",https://affiliate.example/a,신발,1
사이클 장갑,네이버,"https://img.example/b.jpg",35000,29000,https://affiliate.example/b,장갑,2
`
...
assert(rows[0].display_order === 1, 'order')
